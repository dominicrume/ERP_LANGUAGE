# ROOTS-SCORE — ERP Decision Lab v0.3.0 · scored 2026-09-17 · owner: Rume
...
| 4 | Planning [HV] | SEEDLING | | Rume 2026-09-17: instructor authoring is a validator, not a wizard — DEBT.md row 2; scenario-builder wizard in v0.4 |
...
| 10 | Verification | ROOTED | tests/ 65 tests incl. golden scoring regression + zero-code growth proof; scripts/check.sh gate | |
...
| 12 | CI/CD [HV] | SEEDLING | scripts/check.sh + `make check` (pytest then check_roots.py, non-zero on failure) | Rume 2026-09-17: no hosted CI/remote yet — DEBT.md row 3; wire before first external pilot |
